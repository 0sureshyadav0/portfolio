const faqChatData = [
  ...
  },
  {
    ...
    answer: "I'm just a bot, but I'm here and ready to help! 😊",
  },
  {
  ...
  },
  {
    ...
    answer: "Glad to hear that! 🙌 Let me know if you have any questions.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The C Language course runs for 1 month (3–4 hours/week). Regular price: Rs. 4,000. First batch offer: Rs. 1,499.",
  },
  {
    question: "What will I learn in the Python for Beginners course?",
    answer:
      "You’ll learn Python from scratch with live coding sessions. Topics include variables, data types, operators, loops, functions, and basic data structures. Duration: 1 month (12–16 hours). Price: Rs. 5,000. First batch offer: Rs. 4,499.",
  },
  {
    question: "What does the Web Development Bootcamp cover?",
    answer:
      "The Web Development Bootcamp includes HTML, CSS, and basic JavaScript (DOM, events, forms). Duration: 1–1.5 months (15–20 hours). Price: Rs. 7,000. First batch offer: Rs. 4,499.",
  },
  {
    question: "What is included in the App Development - Flutter course?",
    answer:
      "You’ll learn Flutter and Dart to build mobile apps for Android and iOS. Topics: widgets, state management, Firebase integration. Duration: 2–3 months (30–40 hours). Price: Rs. 18,000. First batch offer: Rs. 14,999.",
  },
  {
