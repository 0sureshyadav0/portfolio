...
const buildBottomHeader = (userDetails) => {
  ...
  for (let i = 0; i < links.length; i++) {
    ...
    html +=
      ...
      "<tr>" +
      "<td>" +
      "<i style='font-size: 12px' class='" +
      icon +
      "'></i>" +
      "</td>" +
      "<td  style='padding: 3px 0'>" +
      "<a style='padding: 3px 0' title='" +
      tooltip +
      "' href='" +
      link +
      "'>" +
...
const buildEducation = (education) => {
  ...
  for (let i = 0; i < education.length; i++) {
    ...
    if (printBreak === true) {
      html += "<div class='break extra-margin'></div>" + "<h2>Education</h2>";
    }
    html +=
      "<table>" +
      "<tr>" +
...
const buildProjects = (projects, isNonPersonal = false) => {
  ...
  for (let i = 0; i < projects.length; i++) {
    ...
    for (let r = 0; r < refs.length; r++) {
      let { tooltip, url, icon, link } = refs[r];
      links +=
